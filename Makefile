...
# Misc
.DEFAULT_GOAL = help
.PHONY        : help build up start down logs sh composer vendor sf cc test tailwind
...
## -- Tools 🛠️ ———————————————————————————————————————————————————————————————
tailwind:  ## Run the tailwind watch command
	@$(DOCKER_COMP) exec --detach php bin/console tailwind:build --watch
